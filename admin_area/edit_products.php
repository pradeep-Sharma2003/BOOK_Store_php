...
?>
        ...
        <div class="form-outline w-50 m-auto mb-4">
        <label for="product_brands" class="form-label">Product Brandss</label>
...
?>
      ...
      <div class="text-center">
        <input type="submit" name="edit_product" class="btn bg-info px-3 mb-3" value="Update product">
      </div>
